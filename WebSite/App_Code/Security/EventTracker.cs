...
namespace Planned.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _modifiedByUserNameRegex = new Regex("updateBy", RegexOptions.IgnoreCase);
        
        private static Regex _modifiedByUserIdRegex = null;
        
        private static Regex _modifiedOnRegex = new Regex("updateDate", RegexOptions.IgnoreCase);
